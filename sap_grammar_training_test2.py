...
# Training used use_jax=False, so parsing must too
# Set both the attribute AND the opts dictionary to ensure consistency
if hasattr(net, 'use_jax'):
    net.use_jax = False
    net.opts['use_jax'] = False
    print("✓ Forced model to use_jax=False (attribute and opts)")
