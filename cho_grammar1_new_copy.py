...
for epoch_block in range(n_epochs // 10):
    net.train2(
        ...
        savefilename='g1_ds_speedup_model_copy.pkl'
    )
...
plt.ylim([0, 1.05])
plt.tight_layout()
plt.savefig('figure12_g1_ds_speedup_model_copy_parsing.png',
...
def plot_sentence_treelets(net, sent, sent_idx, target):
    ...
    plt.tight_layout()
    filename = f'g1_ds_speedup_model_copy_treelet_activations_S{sent_idx}_{word_seq.replace(" ", "_")}.png'
