"""
Train a GSC model on the ClassicGP_NPS grammar with probabilities
extracted from the Berkeley parser (sm5).

Grammar rules (from ClassicGP_NPS_probs.txt):
    S -> NP VP, SBAR -> IN S,
    VP -> VBD S | VBD SBAR | VBD NP,
    NP -> DT NN | JJ NN

Modeled after g1_replication_script/cho_grammar1_fulljax.py.

Usage:
    python SAP_analysis/train_classicgp_nps.py
"""
...
# ============================================================================
# Load grammar with probabilities from Script 1 output
# ============================================================================

PROBS_PATH = os.path.join('SAP_stimuli', 'ClassicGP_NPS_probs.txt')
...
SAVE_PREFIX = 'SAP_analysis/classicgp_nps'
...
print("\n" + "=" * 70)
print("Training ClassicGP_NPS model...")
print("=" * 70)
...
# plt.title('ClassicGP_NPS Parsing Accuracy by Sentence Type', fontsize=14)
