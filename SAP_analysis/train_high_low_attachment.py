"""
Train a GSC model on the High/Low Multi-Attachment grammar with probabilities
extracted from the Berkeley parser (sm5).

Grammar includes PP-attachment ambiguity, relative clauses (SBAR -> WHNP VP),
and unary rules (NP -> NNP, ADJP -> JJ).

Usage:
    python SAP_analysis/train_high_low_attachment.py
"""
...
PROBS_PATH = os.path.join('SAP_stimuli', 'High_Low_Multi_Attachment_probs.txt')
SAVE_PREFIX = 'SAP_analysis/high_low_attachment'
...
print("\n" + "=" * 70)
print("Training High/Low Multi-Attachment model...")
print("=" * 70)
...
# plt.title('High/Low Attachment Parsing Accuracy by Sentence Type', fontsize=14)
