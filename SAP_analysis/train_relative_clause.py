"""
Train a GSC model on the Relative Clause grammar with probabilities
extracted from the Berkeley parser (sm5).

Grammar includes relative clauses (SBAR -> WHNP VP), recursive NP
modification (NP -> NP SBAR), and PP attachment (VP -> VBD PP).

Usage:
    python SAP_analysis/train_relative_clause.py
"""
...
PROBS_PATH = os.path.join('SAP_stimuli', 'RelativeClause_probs.txt')
SAVE_PREFIX = 'SAP_analysis/relative_clause'
...
print("\n" + "=" * 70)
print("Training Relative Clause model...")
print("=" * 70)
...
# plt.title('Relative Clause Parsing Accuracy by Sentence Type', fontsize=14)
...
# TREELET_SENTENCES = [
#     'DT NN NN WP VBD DT NNS VBD IN DT NN',
#     'DT NN NN WP DT NNS VBD VBD IN DT NN',
# ]
# TREELET_ROLES = ['(8,3)', '(9,2)'] # (8,3) checks if it's S, (9,2) checks if it's SBAR
# NUM_TREELETS = 10
